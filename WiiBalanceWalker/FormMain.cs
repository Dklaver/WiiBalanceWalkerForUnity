...
namespace WiiBalanceWalker
{
    public partial class FormMain : Form
    {
        ...
        private void InfoUpdate()
        {
            ...
            var data = string.Format("{0} {1} {2} {3}", rwTopLeft, rwTopRight, rwBottomLeft, rwBottomRight);

            //sending the weight values trough the sockets
            _client.tcp.getWiiBoardData(data);
